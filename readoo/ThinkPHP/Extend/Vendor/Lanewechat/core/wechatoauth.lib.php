...
class WeChatOAuth{
    ...
    public static function getAccessTokenAndOpenId($code){
        ...
        //构造请求微信接口的URL
        $url = 'https://api.weixin.qq.com/sns/oauth2/access_token?appid='.WECHAT_APPID_AUTHOR.'&secret='.WECHAT_APPSECRET_AUTHOR.'&code='.$code.'&grant_type='.$grant_type.'';
    ...
    public static function refreshToken($refreshToken){
        $queryUrl = 'https://api.weixin.qq.com/sns/oauth2/refresh_token?appid='.WECHAT_APPID_AUTHOR.'&grant_type=refresh_token&refresh_token='.$refreshToken;
        $queryAction = 'GET';
