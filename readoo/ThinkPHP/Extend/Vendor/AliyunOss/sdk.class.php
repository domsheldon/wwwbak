...
//  北京地址：http://yunyifan.oss-cn-beijing.aliyuncs.com/img/0.jpg
	const DEFAULT_OSS_HOST = 'oss-cn-beijing.aliyuncs.com';
//	const DEFAULT_OSS_HOST = 'fengwoimg.img-cn-beijing.aliyuncs.com';
	...
	public function auth($options){
		...
		if($this->enable_domain_style){echo '123';
