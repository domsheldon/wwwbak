...
<section>
    ...
    <div class="dt_book_ly">
        ...
        <div style="margin:6px 5px 0px 5px;">
            <span style="font-size:12px;line-height:23px;"><?php echo ($info["summary"]); ?></span>
        </div>
    </div>
    ...
    <div class="dt_book_ly">
        ...
        <div class="list">
            <ul>
            <?php if(is_array($comment_list)): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                    <dl>
