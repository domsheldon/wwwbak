                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    	<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo ($vo["join_nums"]); ?></td>
                                            <td class="center">
                                            	<a href="/Admin/Topic/save?id=<?php echo ($vo["id"]); ?>" class="am-btn am-btn-primary am-btn-xs getcode">编辑</a>
                                            	<a href="javascript:;" del-id="<?php echo ($vo['id']); ?>" class="am-btn am-btn-primary am-btn-xs del-data">删除</a>
                                            </td>
                                        </tr><?php endforeach; endif; ?>
                                    </tbody>
                                </table>
                                <a href="/Admin/Topic/save.html" class="am-btn am-btn-primary am-btn-xs">添加话题</a>
                            </div>
        <!-- /.row -->
    </div>
    <!-- /#page-wrapper -->
