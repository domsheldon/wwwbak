                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo ($num_new_day_user); ?>/<?php echo ($num_active_day_user); ?></div>
                                    <div>新增用户数/活跃用户数</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo ($num_new_day_task); ?></div>
                                    <div>新增任务数</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo ($num_releasenote); ?></div>
                                    <div>笔记发布数</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo ($num_feedback); ?></div>
                                    <div>用户反馈吐槽数</div>
                                </div>
                            </div>
                        </div>
