		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				<div class="block_head">
					...
					<?php if(($list_type) != "search"): ?><h2>推送内容列表</h2><?php endif; ?>
				</div>		<!-- .block_head ends -->
				...
				<div class="block_content">
					<form action="" method="get">
						...
						<div class="pagination right">
							<a href="__GROUP__/Users/pushList?page=<?php echo ($page-1); ?>">&laquo;</a>
							<?php $__FOR_START_14098__=1;$__FOR_END_14098__=$sum+1;for($i=$__FOR_START_14098__;$i < $__FOR_END_14098__;$i+=1){ if(($page) == $i): ?><a href="__GROUP__/Users/pushList?page=<?php echo ($i); ?>" class="active"><?php echo ($i); ?></a>
							<?php else: ?>
								<a href="__GROUP__/Users/pushList?page=<?php echo ($i); ?>"><?php echo ($i); ?></a><?php endif; } ?>
							<a href="__GROUP__/Users/pushList?page=<?php echo ($page+1); ?>">&raquo;</a>
						</div>		<!-- .pagination ends -->
