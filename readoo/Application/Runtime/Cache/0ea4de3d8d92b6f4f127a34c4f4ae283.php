...
$(document).ready(function(){
    ...
    $("button").click(function(e){
        var vv = $("textarea").val();
        var backurl = 'http://www.readoo.com/m/otherinfo/getother'; //提交成功返回地址?user_id=27&ta_user_id=6
        var url = 'http://www.readoo.com/m/otherinfo/discuss';  //接口请求地址、参数：note_id；user_id；other_id；content
