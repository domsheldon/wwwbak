				...
				<div class="block_content">
					<form action="" method="get">
						...
						<div class="pagination right">
							<a href="__GROUP__/Wish/wishList?page=<?php echo ($page-1); ?>">&laquo;</a>
							<?php $__FOR_START_27865__=1;$__FOR_END_27865__=$sum+1;for($i=$__FOR_START_27865__;$i < $__FOR_END_27865__;$i+=1){ if(($page) == $i): ?><a href="__GROUP__/Wish/wishList?page=<?php echo ($i); ?>" class="active"><?php echo ($i); ?></a>
							<?php else: ?>
								<a href="__GROUP__/Wish/wishList?page=<?php echo ($i); ?>"><?php echo ($i); ?></a><?php endif; } ?>
							<a href="__GROUP__/Wish/wishList?page=<?php echo ($page+1); ?>">&raquo;</a>
						</div>		<!-- .pagination ends -->
