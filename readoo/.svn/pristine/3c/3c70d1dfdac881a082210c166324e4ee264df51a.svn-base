		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				...
				<div class="block_content">
					<form action="__GROUP__/Ad/ad" method="post" enctype="multipart/form-data">
						...
						<p>
							<label>广告排序:</label><br />
							<input type="text" class="text small" name='sort' value='<?php echo ($info["ad_sort"]); ?>'/> 
						...
						<p>
							<label>记录描述:</label><br />
							<input type="text" class="text small" name='desc' value='<?php echo ($info["ad_desc"]); ?>'/> 
						</p>
						<hr />
						<p>
