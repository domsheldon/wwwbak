		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				...
				<div class="block_content">
					...
					<form action="__GROUP__/Book/classAdd" method="post">
						<?php if(($type) == "padd"): ?><p><label>父分类为：<?php echo ($pname); ?></label></p><br /><?php endif; ?>
						<p>
							<label>分类名称:</label><br />
							<?php if(($type) != "padd"): ?><input type="text" class="text small" name='name' value='<?php echo ($pname); ?>'/> 
							<?php else: ?>
								<input type="text" class="text small" name='name' value=''/><?php endif; ?>
						</p>
						<p>
