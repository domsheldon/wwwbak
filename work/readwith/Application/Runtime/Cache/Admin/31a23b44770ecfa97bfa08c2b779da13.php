		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				<div class="block_head">
					...
					<h2>报名列表 (<?php echo ($count); ?>条)</h2>
					<form action='__GROUP__/Ad/daochu' method='get'>
					<input type='hidden' name='ad_id' value='<?php echo ($ad_id); ?>'/>
					<input type='submit' class='submit small' value='导出excel'/>
					</form>
				</div>		<!-- .block_head ends -->
