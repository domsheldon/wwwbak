...
class UserManage{
    ...
    /**
     * 从有书的服务号获取用户信息，需要获取有书服务号的access_token,
     * 注意地址不一样，，，，，，，，
     * 罗勤勇 2016-1-20
     * @param $openId
     * @return bool|mixed
     */
    public static function getUserInfo_new($openId){
        //获取ACCESS_TOKEN
        $queryUrl = 'https://api.weixin.qq.com/sns/userinfo?access_token='.$openId['access_token'].'&openid='.$openId['openid'];
        return Curl::callWebServer($queryUrl, '', 'GET');
    }
