		...
		<div class="wrapper">		<!-- wrapper begins -->
				...
				<ul id="nav">
					...
					<li>
						...
						<ul>
							<li><a href="__GROUP__/Feed/add">后台发动态</a></li>
			...
			<div class="block">
				<div class="block_head">
					...
					<?php if(empty($pid)): ?><h2>书籍一级分类列表</h2>
					<?php else: ?>
						<h2><?php echo ($pname); ?>的二级分类</h2><?php endif; ?>
					...
					<form action="" method="post">
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><a href="__GROUP__/Book/classList?id=<?php echo ($info["class_id"]); ?>&pname=<?php echo ($info["class_name"]); ?>"><?php echo ($info["class_name"]); ?></a></td>
									...
									|
									<a href="__GROUP__/Book/classAdd?pid=<?php echo ($info["class_id"]); ?>&pname=<?php echo ($info["class_name"]); ?>&type=padd"><b>+</b></a>
									</td>
						...
						<div class="pagination right">
							...
							<?php $__FOR_START_4889__=1;$__FOR_END_4889__=$sum+1;for($i=$__FOR_START_4889__;$i < $__FOR_END_4889__;$i+=1){ if(($page) == $i): ?><a href="__GROUP__/Book/index?page=<?php echo ($i); ?>" class="active"><?php echo ($i); ?></a>
							<?php else: ?>
