...
<link rel="stylesheet" href="http://www.youshu.cc/public/css/style.css">
<style>
...
.dsbj_b em{background: url(__PUBLIC__/images/dsbj.png);display: inline-block;text-indent:-9999px;margin-top: 15px;background-size: 100px 26px;}
...
<section>
    ...
    <div class="zp_zan">
        <div class="h">
            ...
            <span class="r">
                <a href="javascript:;">点赞<?php echo ($info["digg_count"]); ?></a>
            </span>
        </div>
        <div class="list">
        	<?php if(is_array($comment_list)): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dl>
    ...
    <div class="dsbj_b">
        <div class="s"><em>分享</em></div>
        <div class="p"><em>评论</em></div>
        <div class="z"><em>赞</em></div>
    </div>
