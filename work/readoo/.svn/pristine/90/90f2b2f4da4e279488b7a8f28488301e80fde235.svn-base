		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				...
				<div class="block_content">
					<form action="__GROUP__/Users/adminPush" method="post" enctype="multipart/form-data">
						<p>
							<label>推送内容:</label><br />
						...
						<p>
							<label>推送链接:</label><br />
							<input type="text" class="text small" name='href' value=''/>(例：http://www.baidu.com) 
						</p>
						
						<hr />
						<p>
							<input type="submit" class="submit small" value="推送" />
						</p>
					</form>
