					...
					<form action="" method="get">
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo ($info["is_solve"]); ?></td>
									<td><?php echo (date("m-d H:i",$info["create_time"])); ?></td>
									<td><a title='<?php echo ($info["phone_info"]); ?>'>手机型号</a></td>
						...
						<div class="pagination right">
							...
							<?php $__FOR_START_31052__=1;$__FOR_END_31052__=$sum+1;for($i=$__FOR_START_31052__;$i < $__FOR_END_31052__;$i+=1){ if(($page) == $i): ?><a href="__GROUP__/Back?page=<?php echo ($i); ?>" class="active"><?php echo ($i); ?></a>
							<?php else: ?>
