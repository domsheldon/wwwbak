		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				<div class="block_head">
					...
					<h2>平台列表</h2>
					<form action='__GROUP__/Version/add' method='get'>
					...
					<form action="" method="post">
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><a href="javascrip:;"><?php echo ($info["plat"]); ?></a></td>
									<td><?php echo ($info["plat_str"]); ?></td>
									<td><?php echo ($info["version_code"]); ?></td>
									<td><?php echo ($info["apk_url"]); ?></td>
									<td><?php echo (date("y-m-d",$info["create_time"])); ?></td>
									<td class="td">
									<a href="__GROUP__/Version/add?id=<?php echo ($info["id"]); ?>">编辑</a>|
									<a href="__GROUP__/Version/del?id=<?php echo ($info["id"]); ?>">删除</a>
									</td>
