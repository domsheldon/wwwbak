		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				<div class="block_head">
					...
					<h2>书籍列表</h2>
					<form action="__GROUP__/Book/book_search" method="post">
					...
					<form action="" method="post">
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><a href=""><?php echo ($info["title"]); ?></a></td>
									<td><?php echo ($info["author"]); ?></td>
									<td><?php echo (date("y-m-d",$info["create_time"])); ?></td>
									<td class="td">
									<a href="__GROUP__/Book/edit_book?bid=<?php echo ($info["book_id"]); ?>">编辑</a>
									</td>
						...
						<div class="pagination right">
							...
							<?php $__FOR_START_1561__=1;$__FOR_END_1561__=$sum+1;for($i=$__FOR_START_1561__;$i < $__FOR_END_1561__;$i+=1){ if(($page) == $i): ?><a href="__GROUP__/Book/index?page=<?php echo ($i); ?>" class="active"><?php echo ($i); ?></a>
							<?php else: ?>
