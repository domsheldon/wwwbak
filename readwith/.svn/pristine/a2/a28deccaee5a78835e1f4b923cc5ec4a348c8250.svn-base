...
class PushAction extends Action {
	...
	//有书产品的相关id
	private $app_id='mS3ZTirHLX7MoVBpGl2kC2';
	private $app_key='s9z7gEVbWp6ZQQdg4sUro2';
	private $app_secret='Lsi65ZccyT7yxr5TZGonV9';
	private $master_secret='bevfdxrGlY8QhSkqTjHR43';
